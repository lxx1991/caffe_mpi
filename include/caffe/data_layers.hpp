 ...
 */
template <typename Dtype>
class SegCityscapesLayer : public BasePrefetchingDataLayer<Dtype> {
public:
	explicit SegCityscapesLayer(const LayerParameter& param)
	: BasePrefetchingDataLayer<Dtype>(param) {}
	virtual ~SegCityscapesLayer();
	virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
			const vector<Blob<Dtype>*>& top);

	virtual inline const char* type() const { return "SegCityscapes"; }
	virtual inline int ExactNumBottomBlobs() const { return 0; }
	virtual inline int ExactNumTopBlobs() const { return 2; }
 ...
 */
template <typename Dtype>
class RefineCityscapesLayer : public BasePrefetchingDataLayer<Dtype> {
public:
	explicit RefineCityscapesLayer(const LayerParameter& param)
	: BasePrefetchingDataLayer<Dtype>(param) {}
	virtual ~RefineCityscapesLayer();
	virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
			const vector<Blob<Dtype>*>& top);

	virtual inline const char* type() const { return "RefineCityscapes"; }
	virtual inline int ExactNumBottomBlobs() const { return 0; }
	virtual inline int ExactNumTopBlobs() const { return 2; }
